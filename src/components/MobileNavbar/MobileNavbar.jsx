    ...
    <div className={styles.container}>
      <ul className={styles.menu}>
        <li>
          <NavLink
            to="/workouts"
            className={activePage === "workouts" ? styles.activeLink : styles.link}
          >
            <img
        ...
        <li>
          <NavLink
            to="/nutrition"
            className={activePage === "nutrition" ? styles.activeLink : styles.link}
          >
            <img
        ...
        <li>
          <NavLink
            to="/health"
            className={activePage === "health" ? styles.activeLink : styles.link}
          >
            <img
        ...
        <li>
          <NavLink
            to="/friends"
            className={activePage === "friends" ? styles.activeLink : styles.link}
          >
            <img
